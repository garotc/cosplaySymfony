 ...
 */
class getInscriptionGroupRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InscriptionGroupRepository' shared autowired service.
     *
     * @return \App\Repository\InscriptionGroupRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InscriptionGroupRepository.php';

        return $container->privates['App\\Repository\\InscriptionGroupRepository'] = new \App\Repository\InscriptionGroupRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
